...
const PROGRAMAS_FALLBACK = [
  {
    slug: 'proceso-1-a-1-esencial',
    badge: 'Acompañamiento 1 a 1',
    titulo: 'Esencial\n4 sesiones',
    descripcion:
      'Para empezar a mover lo más urgente: dejar de esperar a que la otra persona cambie para poder estar en paz. Juntas vemos de dónde nace de verdad lo que sientes y entrenas a responder desde tu claridad, no desde la reacción.',
    items: [
      '4 sesiones individuales de 60 min, online, una por semana',
      'Notas de voz entre sesiones para sostener lo trabajado',
      'Grabación de cada encuentro para volver a escucharla',
      'Pago por sesión (antes de cada una) o en un solo pago',
    ],
    duracion: '$2,800 MXN · 4 semanas',
    cta_texto: 'Empieza con tu sesión gratis',
    cta_estilo: 'primario',
    destacado: false,
  ...
  {
    slug: 'proceso-1-a-1-completo',
    badge: 'Recomendado',
    titulo: 'Completo\n6 sesiones',
    descripcion:
      'El proceso entero, con más espacio para asentar el cambio y mejor precio por sesión. El acompañamiento completo para volver a ti y sostenerlo en tu día a día.',
    items: [
      '6 sesiones individuales de 60 min, online, una por semana',
      'Notas de voz entre sesiones para sostener lo trabajado',
      'Grabación de cada encuentro para volver a escucharla',
      'Pago único por adelantado · ahorras $900',
    ],
    duracion: '$3,300 MXN · 6 semanas · $550 por sesión',
    cta_texto: 'Empieza con tu sesión gratis',
    cta_estilo: 'dorado',
    destacado: true,
    ancho_completo: false,
