...
const PROGRAMAS_FALLBACK = [
  { slug: 'soberania-relacional-90-dias', badge: '✦ Programa insignia', titulo: 'Soberanía Relacional\n90 días', descripcion: 'El contenedor definitivo de transformación para la mujer líder que decidió dejar de pagar el precio invisible de sostenerlo todo. En 90 días desmontamos de raíz el sobrepensamiento y la autoexigencia —desde la Mente, la Consciencia y el Pensamiento— para devolverte una libertad interna y relacional innegociable. No aprenderás a tolerar el estrés: dejarás de creer que tu paz depende de que tu entorno cambie.', items: ['12 encuentros individuales de alta claridad (mentoría 1 a 1)', 'Línea directa de contención por nota de voz entre sesiones', 'Biblioteca de soberanía mental y grabación de cada sesión', 'Comunidad privada de mujeres en el mismo camino'], duracion: '90 días · Inicio por agenda', cta_texto: 'Quiero mi transformación', cta_estilo: 'dorado', destacado: true, ancho_completo: false, requisito: null, publicado: true },
  { slug: 'talleres-de-alta-claridad', badge: 'Encuentros grupales', titulo: 'Talleres de Alta Claridad', descripcion: 'Espacios de comprensión grupal, en vivo, para pausar el ruido del entorno y volver a tu centro. Una vez al mes abrimos un contenedor enfocado en los desafíos más reales de la mujer de hoy —la culpa, los límites, la carga mental— mirados desde los 3 Principios. Profundo, cercano y en comunidad.', items: ['Masterclass temática en vivo (90 a 120 min)', 'Espacio de mentoría directa para tus situaciones reales', 'Acceso a la grabación durante 30 días'], duracion: 'Mensual · En vivo y online', cta_texto: 'Quiero participar', cta_estilo: 'primario', destacado: false, ancho_completo: false, requisito: null, publicado: true },
  { slug: 'mentoria-de-maestria', badge: 'Para quien ya inició', titulo: 'Mentoría de Maestría', descripcion: 'El espacio exclusivo para proteger tu claridad y expandir tu soberanía mes a mes. Integrar los 3 Principios en el día a día es un camino de profundización continua: aquí sigues navegando tus desafíos profesionales y familiares con ligereza, evitando que la mente vuelva al piloto automático de la sobrecarga.', items: ['2 calibraciones de centro al mes (60 min cada una)', 'Línea de acompañamiento activo por nota de voz', 'Acceso a las nuevas herramientas de la metodología', 'Auditoría trimestral de tu evolución relacional'], duracion: 'Renovable mensualmente', cta_texto: 'Consultar disponibilidad', cta_estilo: 'secundario', destacado: false, ancho_completo: true, requisito: 'Haber completado el programa de 90 días o una Sesión de Claridad previa.', publicado: true },
];
